"""
Generate speed histograms at different angular positions from phase data.
Each histogram corresponds to a fixed-angle window across revolutions.
"""
...
def compute_speed_matrix(phase, phase_time, angle_starts, angle_width_rad=0.4, min_points=10):
    """Compute a 2D [angle_bin, revolution] matrix of instantaneous speeds."""
