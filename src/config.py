...
# ─── Phase Tracking ───────────────────────────────────────────────────
CONTINUITY_CONSTRAINT = REFERENCE_NUM_POINTS // 10  # Neighborhood size for phase continuity search. Set to REF_NUM_POINTS // 10 originally. REFERENCE_NUM_POINTS // 2 is basically removes it.
